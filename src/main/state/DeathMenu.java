...
public class DeathMenu implements State {
    ...
    public void render(Graphics g) {
        g.drawImage(background, 0, 0, main.component.Window.WINDOW_WIDTH, main.component.Window.WINDOW_HEIGHT, null);
        ...
        for (int i = 0; i < choices.length; i++){
            ...
            g.drawString(choices[i], (main.component.Window.WINDOW_WIDTH + stringWidth) / 2 - stringWidth, main.component.Window.WINDOW_HEIGHT / 2 + 100 + 50 * i);
        }
        ...
        if (hasSelected){
            ...
            g.fillRect(0, 0, main.component.Window.WINDOW_WIDTH, main.component.Window.WINDOW_HEIGHT);
            currentAlpha += 255 / 15;
            if (currentAlpha > 255){
                currentAlpha = 255;
            }
